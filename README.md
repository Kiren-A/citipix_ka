...
- Research and implement ```$.attr()``` to apply the correct background image through changing class names
- If a user submits:
...
![Deliverable](deliverables/citipix_solution.png)


After entering "NYC" and submitting:


![Deliverable](deliverables/citipix_solution_nyc.png)
...
You should have submitted a proposal and wireframes for your final project. Next up, you'll be writing pseudo code for the interactivity you would like to add.  For this week, you should begin writing psuedo code and a draft of the HTML/CSS for your application - this should be turned into your instructor by the end of week 7.